...
//         std::vector<short int> TriggersInfo_ (0,NTRIGGERS);
        ...
        for (vector < pat::GenericParticle >::const_iterator iTrack1 = thePATTrackHandle->begin(); iTrack1 != thePATTrackHandle->end(); ++iTrack1)
        {
            ...
            //
            //if ((p4mup_0c + p4mum_0c + p4k1).M() - (p4mup_0c + p4mum_0c).M() + PDG_JPSI_MASS > 4.2) continue; // May be I should change the restriction
            //
            ...
            //
                //
                    ...
                    if(B_mass_cjp_tmp < 5.00) continue;
                    if(B_mass_cjp_tmp > 5.50) continue;
                    //
                    ...
                    if ((p4fit_mu1 + p4fit_mu2 + p4fit_K1).M() > 5.50) continue;
                    if ((p4fit_mu1 + p4fit_mu2 + p4fit_K1).M() < 5.00) continue;
                    ///
                    ////
                    ////
